...
Label_Sina.place(relx=0.03, rely=0.05, height=18, width=32)
Label_Sohu = tk.Label(root, text='''搜狐''')
Label_Sohu.place(relx=0.22, rely=0.05, height=18, width=32)
Label_XinhuaNet = tk.Label(root, text='''新华网''')
Label_XinhuaNet.place(relx=0.03, rely=0.15, height=18, width=46)
...
Label_T_1.place(relx=0.15, rely=0.05, height=18, width=18)
Label_T_2 = tk.Label(root, text='''条''')
Label_T_2.place(relx=0.33, rely=0.05, height=18, width=18)
Label_T_3 = tk.Label(root, text='''条''')
Label_T_3.place(relx=0.17, rely=0.15, height=18, width=18)

Button_Crawler = tk.Button(root, text='''爬取''', command=crawler)
Button_Crawler.place(relx=0.47, rely=0.05, height=26, width=54)
Label_S_1 = tk.Label(root, text='''或''')
Label_S_1.place(relx=0.57, rely=0.08, height=18, width=18)
Button_Select_News = tk.Button(root, text='''选择新闻文件''', command=select_news)
Button_Select_News.place(relx=0.47, rely=0.15, height=26, width=110)

Label_L_1 = tk.Label(root, text='''共''')
Label_L_1.place(relx=0.7, rely=0.1, height=18, width=17)
...
Label_R_1.place(relx=0.8, rely=0.1, height=18, width=80)

Label_L_2 = tk.Label(root, text='''筛选''')
Label_L_2.place(relx=0.03, rely=0.25, height=18, width=32)
date_f = tk.StringVar()
...
Label_Date.place(relx=0.33, rely=0.25, height=18, width=46)
day_f = tk.StringVar()
...
Label_R_2.place(relx=0.47, rely=0.25, height=18, width=72)

Button_Filter = tk.Button(root, text='''筛选''', command=data_filter)
Button_Filter.place(relx=0.63, rely=0.25, height=26, width=54)
Label_L_3 = tk.Label(root, text='''筛选出''')
Label_L_3.place(relx=0.73, rely=0.25, height=18, width=46)
Label_M_3 = tk.Label(root, textvariable=filter_n)
filter_n.set('0')
Label_M_3.place(relx=0.8, rely=0.25, height=18, width=34)
Label_R_3 = tk.Label(root, text='''条新闻''')
Label_R_3.place(relx=0.87, rely=0.25, height=18, width=48)

Button_UserDict = tk.Button(root, text='''用户词词典''', command=show_userdict)
Button_UserDict.place(relx=0.05, rely=0.35, height=26, width=96)
Button_StopWords = tk.Button(root, text='''停用词词典''', command=show_stopwords)
Button_StopWords.place(relx=0.22, rely=0.35, height=26, width=96)
Button_Disambiguation = tk.Button(root, text='''消歧词典''', command=show_disambiguation_dict)
Button_Disambiguation.place(relx=0.38, rely=0.35, height=26, width=82)
...
Label_Eps.place(relx=0.05, rely=0.45, height=18, width=156)
...
Label_MinSamples.place(relx=0.36, rely=0.45, height=18, width=110)
...
Button_Cluster.place(relx=0.63, rely=0.45, height=26, width=186)

Label_L_4 = tk.Label(root, text='''共获得''')
Label_L_4.place(relx=0.67, rely=0.55, height=18, width=46)
Label_M_4 = tk.Label(root, textvariable=hot_num)
hot_num.set('0')
Label_M_4.place(relx=0.75, rely=0.55, height=18, width=20)
Label_R_4 = tk.Label(root, text='''处热点''')
Label_R_4.place(relx=0.8, rely=0.55, height=18, width=50)

Button_Show1 = tk.Button(root, text='''查看聚类效果图''', command=show_cluster_result)
Button_Show1.place(relx=0.05, rely=0.55, height=26, width=124)
Button_Show2 = tk.Button(root, text='''查看热点条形图''', command=show_hot_barh)
Button_Show2.place(relx=0.27, rely=0.55, height=26, width=124)
Button_Show3 = tk.Button(root, text='''查看热点饼图''', command=show_hot_pie)
Button_Show3.place(relx=0.47, rely=0.55, height=26, width=110)

Label_L_5 = tk.Label(root, text='''第''')
Label_L_5.place(relx=0.42, rely=0.65, height=18, width=20)
...
Label_R_5.place(relx=0.57, rely=0.65, height=18, width=50)
